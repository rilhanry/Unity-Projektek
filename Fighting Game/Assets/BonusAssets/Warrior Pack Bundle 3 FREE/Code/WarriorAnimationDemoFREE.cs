...
public class WarriorAnimationDemoFREE : MonoBehaviour 
{
	...
	void Update()
	{
		...
		float z = Input.GetAxisRaw("PlayerOneHorizontal");
		float x = -(Input.GetAxisRaw("PlayerOneVertical"));
	...
	{  
		...
		//directional inputs
		float v = Input.GetAxisRaw("PlayerOneHorizontal");
		float h = -Input.GetAxisRaw("PlayerOneVertical");
